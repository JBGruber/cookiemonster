...
If you are looking for a way to use cookies in shiny apps you can check out the [cookies package](https://cran.r-project.org/web/packages/cookies/index.html).
